...
//         className="flex items-center gap-1 text-sm text-purple-600 br-gradient-to-br from-purple-50 to-purplr-100 ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg"
//         >
